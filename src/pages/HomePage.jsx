...
const HomePage = () => {
  return (
    <main className="relative z-10">
      <section className="px-4 sm:px-6 flex items-center pt-8 pb-4">
        <div className="max-w-7xl mx-auto text-center">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.2 }}
            className="hero-glow rounded-3xl p-8 py-0 sm:p-12 sm:pb-0" 
          >
            <h1 className="text-5xl sm:text-5xl md:text-6xl font-bold mb-6 gradient-text" style={{lineHeight: '1.2'}}>
              BluBridge to AI Excellence.
            </h1>
            <p className="text-lg sm:text-l text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed">
            Bridging the gap between intelligence and innovation with cutting-edge AI solutions that optimize performance and shape the future.
            </p>
      ...
      <div className="grid-item p-6 h-full flex flex-col pr-0 "><p className='we-are'>We are an aspiring Large Language Model (LLM) research company founded on 15<sup>th</sup> February 2025. The scope of research, we wish to undertake is into the following disciplines:</p></div>
      ...
      <section className="px-4 sm:px-6 content-section">
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-black">
             Blubridge – Smarter Engineering, Faster Innovation
            </h2>
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
             We are dedicated to advancing tokenisation and prediction modelling across three key areas
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <FeatureCard
              icon={Bot}
              title="Chatbots"
              description="Smart chatbots engage users, resolve queries, offer seamless interaction, and scale customer support without delays."
              delay={0.1}
            />
            <FeatureCard
              icon={FileAudio}
              title="Audio"
              description="Transform audio creation with AI—from voice cloning to noise reduction and real-time audio enhancement."
              delay={0.2}
            />
            <FeatureCard
              icon={FileImageIcon}
              title="Images"
              description="Create stunning visuals instantly—AI Images automate design, improve quality, and enable limitless creative possibilities."
              delay={0.3}
            />
          </div>
        </div>
