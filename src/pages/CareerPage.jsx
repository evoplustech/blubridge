            ...
            <div className='main-inner'>
                <div className="rounded-xl p-8 px-9 shadow-lg border border-gray-200/50 inner-page">
                    ...
                    <h2 className='text-lg font-bold pt-3 text-black'><span className='underline'>How to apply</span>:-</h2>
                      ...
                      <p className='pt-1'><img style={{ float:'left', marginRight:'7px'}} src='/images/join.png'></img><Link to="/join-our-team" onClick={() => setIsMobileMenuOpen(false)} className="font-medium text-[#046bd2] underline pt-2">Joining Our Research Unit</Link></p>
