    ...
    <>
      ...
      >
        <nav className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          {/* Desktop Menu */}
         <div className="hidden md:flex items-center space-x-6 lg:space-x-8 relative group">
  <Link to="/" className="text-black font-medium hover:text-gray-700">HOME</Link>

  {/* Careers with dropdown */}
  <div className="relative group">
    <Link to="/Careers" className="text-black font-medium hover:text-gray-700">
      CAREERS
    </Link>

    {/* Dropdown menu */}
    <div className="absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-md opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto transition duration-200 z-50">
      <Link to="/Careers/Openings" className="block px-4 py-2 text-sm text-gray-800 hover:bg-gray-100">Openings</Link>
    
    </div>
  </div>

  <Link to="/Join" className="text-black font-medium hover:text-gray-700">RESEARCH CULTURE</Link>
